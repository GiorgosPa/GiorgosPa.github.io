...
function bubbleChart() {
  ...
  var fillColor = d3.scale.ordinal()
    ...
    .range(['#d84b2a', '#00FFFF', '#7aa25c', '#FFFF00']);
  ...
  function createNodes(rawData) {
    ...
    var myNodes = rawData.map(function (d) {
      return {
        id: d.id,
        radius: radiusScale(+d.accidents),
        value: d.accidents,
        name: d.intersection,
        killed: d.killed,
        injured: d.injured,
  ...
  var chart = function chart(selector, rawData) {
    ...
    // with `+`.
    var maxAmount = d3.max(rawData, function (d) { return +d.accidents; });
    ...
    bubbles = svg.selectAll('.bubble')
      ...
      .classed('bubble', true)
      .attr('r', 0)
      .attr('fill', function (d) { return fillColor(d.borough); })
      .attr('stroke', function (d) { return d3.rgb(fillColor(d.borough)).darker(); })
      .attr('stroke-width', 2)
  ...
  function showDetail(d) {
    ...
    var content = '<div class="tooltip"><span class="name">Intersection: </span><span class="value">' +
                  d.name +
                  '</span><br/>' +
                  '<span class="name">Accidents: </span><span class="value">' +
                  addCommas(d.value) +
                  '</span><br/>' +
                  '<span class="name">Killed: </span><span class="value">' +
                  d.killed +
                  '</span><br/>' +
                  '<span class="name">Injured: </span><span class="value">' +
                  d.injured +
                  '</span><br/>' +
...
// Load the data.
d3.csv('processing/intersections.txt', function(dataset){
