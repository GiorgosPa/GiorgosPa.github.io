    ...
    d3.select("button")
            .on("click", function () {
                if (filename === "barchart/output0.csv") {
                    ...
                    d3.select("#hist-title").text = "Crimes in San Francisco's Mission district during 2015";
                } else {
                    filename = "barchart/output0.csv";
                    d3.select("#hist-title").text = "Crimes in San Francisco's Tenderloin district during 2015";
                }
                upd_hist(filename);
            });
}]);
